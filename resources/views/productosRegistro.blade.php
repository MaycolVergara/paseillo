...
@section('content')
    ...
    <div
        ...
        <form action="{{ url('/dashboard/productoRegistro') }}" method="POST" enctype="multipart/form-data" method="POST" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="descripcion_producto" rows="4" placeholder="Detalla los ingredientes y características del producto..."
