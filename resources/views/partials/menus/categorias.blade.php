<div>
    <button data-tip="Categoría"
        ...
        <span class="nav-item-text flex-1 text-left whitespace-nowrap overflow-hidden">Categoría</span>
    ...
    <div class="submenu-wrapper">
        <div class="submenu-inner">
            <div class="ml-5 pl-4 mt-1.5 mb-1 border-l-2 border-dashed border-gray-200 dark:border-gray-700 space-y-1">
                {{-- UN SOLO FOREACH PARA TODO --}}
                @php
                    $categorias = \App\Models\Categoria::all();
                @endphp
                @foreach( $categorias as $categoria)
                    @php
                        // 1. Convertimos el nombre exacto de la base de datos a minúsculas
                        $nombreCat = strtolower($categoria->nombre_categoria);
                        $emoji = '🍽️';

                        // 2. Comparamos correctamente usando la variable $nombreCat
                    ...
                    @endphp
                    {{-- Este es el HTML que te faltaba para dibujar la categoría --}}
