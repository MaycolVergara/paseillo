<div>
    <button data-tip="Categoría"
        ...
        <span class="flex items-center justify-center w-9 h-9 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-500 group-hover:bg-orange-100 dark:group-hover:bg-orange-900/30 group-hover:text-orange-500 transition-colors duration-200 shrink-0">
            {{-- 1er CAMBIO: Icono principal de Categorías (Etiqueta) --}}
        ...
        <span class="nav-chevron-wrap">
            {{-- 2do CAMBIO: Icono de la flechita (Chevron) --}}
        ...
        <div class="submenu-inner">
            <div class="ml-5 pl-4 mt-1.5 mb-1 border-l-2 border-dashed border-gray-200 dark:border-gray-700 space-y-1">
                ...
                @foreach($categoriesList as $category)
                    ...
                    @endphp
                    <h5 class="flex items-center gap-3 px-2 py-1.5 group/item rounded-xl hover:bg-orange-50 dark:hover:bg-orange-950/20 transition-all cursor-pointer">
                        {{-- Opcional: Un pequeño guión o punto para los sub-items --}}
                        <i data-lucide="minus" class="w-3 h-3 text-gray-400 group-hover/item:text-orange-500 transition-colors"></i>
