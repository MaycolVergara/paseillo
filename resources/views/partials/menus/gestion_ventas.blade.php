                ...
                <div class="ml-5 pl-4 mt-1.5 mb-1 border-l-2 border-dashed border-gray-200 dark:border-gray-700 space-y-1">
                    ...
                    <a href="{{ url('/dashboard/saleDetails')}}"
                       class="nav-link sub-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-200">
                        <i data-lucide="calendar" class="w-4 h-4 shrink-0"></i> Reporte Diario
                    </a>

                    {{-- Semanal --}}
                    <a href="{{ route('reports.sales.weekly') }}"
                       class="nav-link sub-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-200">
                        <i data-lucide="calendar-days" class="w-4 h-4 shrink-0"></i> Semanal
                    </a>

                    {{-- Mensual --}}
                    <a href="{{ route('reports.sales.monthly') }}"
                       class="nav-link sub-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-200">
                        <i data-lucide="calendar-range" class="w-4 h-4 shrink-0"></i> Mensual
                    </a>

                    {{-- Anual --}}
                    <a href="{{ route('reports.sales.annual') }}"
                       class="nav-link sub-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-200">
                        <i data-lucide="award" class="w-4 h-4 shrink-0"></i> Anual
                    </a>

                    {{-- Productos Eliminados --}}
                    <a href="{{ url('/dashboard/listadoProductosEliminados') }}"
                       class="nav-link sub-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all duration-200">
