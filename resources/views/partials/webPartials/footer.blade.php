<footer class="bg-brand-black pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 mb-8 border-b border-white/10">
            <div class="md:col-span-2">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <div class="font-condensed text-[10px] font-700 tracking-[3px] text-brand uppercase">Pizzas & Burger · Huanta</div>
                    </div>
                </div>
                <p class="text-white/40 text-sm leading-relaxed mb-6 max-w-sm">El mejor local de comida rapida de Huanta, Ayacucho. Pizzas artesanales, burgers jugosas, krispy crujiente y salchipapas con salsas de la casa.</p>
            ...
            <div>
                <div class="font-condensed text-xs font-700 tracking-[2px] text-white/40 uppercase mb-5">Navegación</div>
                <div class="flex flex-col gap-3">
                    <a href="#inicio" class="font-condensed text-sm text-white/40 hover:text-brand transition-colors">Inicio</a>
                    <a href="#especialidades" class="font-condensed text-sm text-white/40 hover:text-brand transition-colors">Especialidades</a>
                    <a href="#carta" class="font-condensed text-sm text-white/40 hover:text-brand transition-colors">Carta</a>
                    <a href="#galeria" class="font-condensed text-sm text-white/40 hover:text-brand transition-colors">Galería</a>
                    <a href="#nosotros" class="font-condensed text-sm text-white/40 hover:text-brand transition-colors">Nosotros</a>
                </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="font-condensed text-xs text-white/20">© 2025 <span class="text-brand">Paseillo Pizzas & Burger</span>. Todos los derechos reservados.</p>
            <div class="flex gap-5">
                <a href="#" class="font-condensed text-xs text-white/20 hover:text-white/50 transition-colors">Privacidad</a>
                <a href="#" class="font-condensed text-xs text-white/20 hover:text-white/50 transition-colors">Términos</a>
            </div>
        </div>
    </div>
</footer>
