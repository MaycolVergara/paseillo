    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
        <div class="mb-16 text-center">
            <div
                ...
                <span class="font-condensed font-700 text-brand text-xs uppercase tracking-[3px]">🔥 Los más
                    pedidos</span>
            </div>
            <h2 class="reveal font-anton mb-6 text-[clamp(36px,6vw,80px)] uppercase leading-none text-white">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div
                ...
                <div class="img-zoom relative aspect-[3/2] overflow-hidden">
                    ...
                    <div class="from-brand-black/80 absolute inset-0 bg-gradient-to-t to-transparent"></div>
                    <div
                ...
                <div class="p-5">
                    <h3 class="font-condensed font-900 mb-2 text-lg uppercase tracking-wide text-white">
