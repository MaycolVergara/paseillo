<div class="fixed bottom-[120px] right-6 z-50 group flex flex-col items-end gap-3">
...
<div class="fixed bottom-10 right-6 z-50 group flex flex-col items-end gap-3">
    <div class="bg-brand-black text-white font-condensed font-700 text-xs uppercase tracking-wide px-4 py-2 rounded-full shadow-xl opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap">
        📲 Ordena aquí — WhatsApp
    </div>
    <a href="https://wa.me/51921829555?text=Hola%20Paseillo%2C%20quiero%20hacer%20un%20pedido" target="_blank" class="relative w-[60px] h-[60px] bg-[#25D366] rounded-full flex items-center justify-center text-3xl shadow-[0_8px_30px_rgba(37,211,102,0.5)] hover:scale-110 hover:shadow-[0_12px_40px_rgba(37,211,102,0.6)] transition-all duration-300">
        <img
