...
<header id="nav" class="fixed left-0 right-0 top-0 z-50 bg-white transition-all duration-300">
        ...
        <div class="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
            ...
            <nav class="hidden items-center gap-5 lg:flex">
                ...
                <a href="#especialidades"
                    class="nav-link font-condensed font-700 hover:text-brand text-sm uppercase tracking-wide text-gray-700 transition-colors">Especialidades</a>
                <a href="#combos"
                    class="nav-link font-condensed font-700 hover:text-brand text-sm uppercase tracking-wide text-gray-700 transition-colors">Combos</a>
                <a href="#carta"
                    class="nav-link font-condensed font-700 hover:text-brand text-sm uppercase tracking-wide text-gray-700 transition-colors">La Carta</a>
                <a href="#galeria"
    ...
    <div id="mob"
        ...
        <div class="flex flex-col gap-1 px-4 py-4">
            ...
            <a href="#especialidades" onclick="closeNav()"
                class="font-condensed font-700 hover:text-brand hover:bg-brand/5 rounded-lg px-3 py-2.5 text-base uppercase tracking-wide text-gray-800 transition-all">Especialidades</a>
            <a href="#combos" onclick="closeNav()"
                class="font-condensed font-700 hover:text-brand hover:bg-brand/5 rounded-lg px-3 py-2.5 text-base uppercase tracking-wide text-gray-800 transition-all">Combos</a>
            <a href="#carta" onclick="closeNav()"
                class="font-condensed font-700 hover:text-brand hover:bg-brand/5 rounded-lg px-3 py-2.5 text-base uppercase tracking-wide text-gray-800 transition-all">La Carta</a>
