            ...
            <div
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-red-400">
                        ...
                        <div id="search-results" class="search-results-container hidden shadow-2xl">
                            @foreach($products as $producto)
                                <div
                                    ...
                                    <span
                                        class="text-[10px] bg-red-100 dark:bg-red-500/20 text-red-600 dark:text-red-400 px-2 py-0.5 rounded-md">S/ {{ number_format($producto->price, 2) }}</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <div
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-8 text-center text-sm font-medium text-gray-400">No hay productos
                            todavía.
                        </td>
                    </tr>
                @endforelse
        ...
        <div
            ...
            <div class="flex items-center gap-2">
                ...
                <span
                    class="text-2xl font-black text-gray-900 dark:text-white italic">S/ {{ number_format($overallTotal ?? 0, 2) }}</span>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-end gap-4 w-full lg:w-auto">
                <a href="{{ url('/dashboard/issueReceiptDelivery/' . $id) }}" target="_blank"
                   class="w-full md:w-auto px-6 py-3 bg-red-500 text-white text-sm font-bold rounded-xl shadow-lg text-center flex items-center justify-center h-[46px]">Emitir
                    Boleta</a>
