...
<div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
    <div class="animate-in fade-in duration-500">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-xl font-black text-gray-900 dark:text-white tracking-tight italic">Configuración del Sistema</h2>
                <p class="text-xs font-semibold text-gray-400 mt-0.5 uppercase tracking-widest">Personaliza la identidad visual de tu empresa</p>
            </div>
        </div>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <div class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-500 dark:text-gray-400 flex items-center justify-between group-hover:border-red-400 transition-all">
                                    ...
                                    <i data-lucide="upload" class="w-[18px] h-[18px] text-gray-400"></i>
                                </div>
                            </div>
                        </div>
                    </div>
