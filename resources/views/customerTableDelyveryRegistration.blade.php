...
@section('content')
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs font-semibold text-gray-400 mt-0.5 uppercase tracking-widest">Configuración de Delivery</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div
            ...
            <form action="{{ url('/dashboard/customerTableDelyveryRegistration/insert') }}" method="POST" class="p-6">
                @csrf
                <div class="mb-6">
                    <label
