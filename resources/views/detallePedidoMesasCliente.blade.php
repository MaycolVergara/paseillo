...
@section('content')
    ...
    <div
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            ...
            <a href="{{ url('/dashboard/mesasView') }}"
        ...
        <form action="{{ url('/dashboard/guardarPedido/' . $id) }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4 items-end">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="relative">
                        <select name="id_producto" id="select-producto" required
                ...
                <div class="lg:col-span-1">
                    ...
                    <input type="text" name="personalizado" placeholder="Sin cremas..."
                ...
                <div class="lg:col-span-1">
                    ...
                    <input type="number" name="cantidad" id="input-cantidad" min="1" value="1" required
                ...
                <div class="lg:col-span-2">
                    <button type="submit"
                            class="w-full py-2.5 bg-gradient-to-b from-amber-400 to-amber-500 hover:from-amber-500 text-white text-sm font-black rounded-xl shadow-lg transition-all active:scale-95 flex items-center justify-center h-[42px]">
                        Guardar Pedido
                    </button>
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                @forelse($detalleVentas as $detalle)
                    @php
                        $productoInfo = $productos->where('id_producto', $detalle->id_producto)->first();
                        $nombreProducto = $productoInfo ? $productoInfo->nombre_producto : 'Producto Eliminado';
                    @endphp
                    ...
                    <tr class="group hover:bg-orange-50/30 dark:hover:bg-orange-950/10 transition-all">
                        ...
                        <td class="px-6 py-4 text-right">
                            <form action="{{ url('/dashboard/eliminarDetalle/' . $detalle->id_detalle) }}"
                                  method="POST">
                                @csrf
                                @method('DELETE')
